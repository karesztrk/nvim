...
vim.opt.complete = ".^5,w,t^5"                          -- Match limit for the completion
vim.opt.autocomplete = true                             -- Native insert-mode autocomplete
vim.opt.pumborder = 'none'
vim.opt.showmode = false                                -- Don't show mode in command line
vim.opt.pumheight = 10                                  -- Popup menu height
vim.opt.pummaxwidth = 40                                -- Popup max visible
...
-- Custom status line
local statusline = require('plugins.statusline').statusline
